...
static const char selbordercolor[]  = "#a59f85";
static const char selbgcolor[]      = "#75715e";
static const char selfgcolor[]      = "#f9f8f5";
...
/* tagging */
static const char *tags[] = { "term", "www", "dev", "comm", "mail", "scratch", "sys", "status" };
...
static const char *opencmd[]  = { "dmenu_open", NULL };
static const char *githubcmd[]  = { "dmenu_github", NULL };
static const char *netcfgcmd[]  = { "dmenu_netcfg", NULL };
